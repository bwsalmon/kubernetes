...
// some external view.
func NewExternalSource[KeyType comparable]() *SourceSpec {
	return &SourceSpec{
...
// Used with the spec "New" call. Define a new view generated by running map reduce on the given source.
//
...
// Create an external view to mirror state from an external source.
// Note that the values passed in using Update must be immutable;
// once passed in they are owned by Fort and cannot be changed.
