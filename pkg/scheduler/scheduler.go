...
type Scheduler struct {
	...
	SchedulePod func(ctx context.Context, fwk framework.Framework, state fwk.CycleState, pod *v1.Pod, podBatchSize int) (ScheduleResult, error)
...
type ScheduleResult struct {
	...
	// Additional hosts available for others in the batch
	BatchHosts []string
}
